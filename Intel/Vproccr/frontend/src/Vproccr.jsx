...
import VproBannerImg from "./assets/Vproccr-img.png";
import Vproccrimage1 from "./assets/Vproccr-image1.png";
...
const Vproccr = () => {
  ...
  <Typography mb={4}>
    See how choosing today’s standard for business PCs—Intel® Core™ Ultra 200V series processors—helps you create a more productive and engaged workforce, align with your C-suite’s strategic priorities, and manage complex tech infrastructure while delivering tangible ROI.
  </Typography>

  <Typography variant="h4" mb={2}>
    Integrated. Validated. Business-Ready.
  </Typography>

  <Typography mb={4}>
    Work smarter than ever with Intel vPro® and business PCs powered by Intel® Core™ Ultra processors.
  </Typography>
  ...
  />
          ...
          <Box component="form" onSubmit={handleSubmit} flex={1}>
            <Typography mb={2}>
              ...
              <br />
              <strong>
                “Get your guide to Intel-powered business PCs”
              </strong>
            </Typography>
            {[
